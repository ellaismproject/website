<template>
    <div class="home">
        ...
        <section class="hero is-medium is-ella overview">
            <div class="hero-body">
                <div class="container has-text-centered">
                    <i18n path="page.home.pitch.content" tag="p" class="is-size-3-desktop has-text-weight-light" style="margin-bottom:1.75rem;">
                    ...
                    <div class="tile is-ancestor">
                        <div class="tile is-parent">
                            <article class="tile is-child box">
                                <p class="title is-4"><i class="fas fa-terminal"/>
                                    {{ $t('page.home.card_1.title') }}</p>
                                <div class="content">
                        ...
                        <div class="tile is-parent">
                            <article class="tile is-child box">
                                <p class="title is-4"><i class="fas fa-balance-scale"/>
                                    {{ $t('page.home.card_2.title') }}</p>
                                <div class="content">
                        ...
                        <div class="tile is-parent">
                            <article class="tile is-child box">
                                <p class="title is-4"><i class="fas fa-users"/>
                                    {{ $t('page.home.card_3.title') }}</p>
                                <div class="content">
