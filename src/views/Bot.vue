    ...
    <div class="bot">
        <div class="hero is-medium is-ella">
            <div class="hero-body">
                <div class="container has-text-centered">
                    ...
                    <h2 class="subtitle">{{ $t('page.bot.sub_title') }}</h2>
                </div>
            </div>
        </div>
        <section class="section">
            <div class="container">
                <div class="content">
                    ...
                    <p>
                        ...
                        <a
                                href="https://keybase.io/buzzkillb" class="bl-text-secondary">Buzzkillb</a> for the
                        initial
                        donations that made the faucet possible. And <a href="https://pool.ellaism.io/" target="_blank"
                                                                        class="bl-text-secondary">Dev</a> Pool sponsors
                        the
                        transaction fees.
                    </p>
            ...
            <pre class="highlight"><code>!carbon &lt;address&gt;
                    ...
                    <h5 id="splitdonations" class="bl-h5">Split Donations</h5>
            ...
            <pre class="highlight">              <code>!split &lt;dev|community|token|default&gt; &lt;percentage&gt; &lt;address&gt;
                    ...
                    <p class="bl-pre-line">
                        ...
                        <percentage> to Dev Fund, Community Fund, Contributor Fund or the split address for Dev Fund and
                    ...
                    <address>. For example:
                        ...
                        <div class="bl-highlight-wrapper"><pre class="highlight">            <code>!split dev 5% 0x65767ec6d4d3d18a200842352485cdc37cbf3a21
            </code>
          </pre>
                        </div>
            ...
            <pre class="highlight">            <code>!mining withdraw &lt;split contract address&gt;
                        ...
                        <h5 id="testnetfaucet" class="bl-h5">Testnet Faucet</h5>
                        <p class="bl-pre-line">
                        ...
                        <h5 id="rsvpbot" class="bl-h5">RSVP Bot</h5>
                        <p class="bl-pre-line">
                        ...
                        <div class="bl-highlight-wrapper"><pre class="highlight"><code>!rsvp yes
          </code></pre>
                        </div>

                        <h5 id="blockchaindiscordlogs" class="bl-h5">Blockchain Discord Logs</h5>
                        <p class="bl-pre-line">
                        ...
                        <ul class="bl-list-bullet bl-spacer-b-m-40 bl-spacer-l-m-40 bl-spacer-mob-l-m-30">
                            <li>ELLA Ethusiasts role changes: <a
                                    href="https://explorer.ellaism.io/address/0x69808D56a15A4465F898Fd61a8a54beb24788Eb0"
                                    target="_blank" class="bl-text-secondary-underline">0x69808D56a15A4465F898Fd61a8a54beb24788Eb0</a>
                            </li>
                            <li>ELLA Regulars role changes: <a
                                    href="https://explorer.ellaism.io/address/0x05d12A005524Db8791A25C61B884eAD293a12F2a"
                                    target="_blank" class="bl-text-secondary-underline">
                                0x05d12A005524Db8791A25C61B884eAD293a12F2a
                            </a></li>
                        </ul>

                        <p class="bl-font-small">Updated: March 05, 2017</p>
                    </address>
                </div>
            </div>
        </section>
