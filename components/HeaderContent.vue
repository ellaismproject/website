    ...
    <b-navbar class="is-nav" wrapper-class="container">
      <template slot="brand">
        <b-navbar-item tag="nuxt-link" :to="localePath({ name: 'index' })">
          <img src="~/assets/ellaism-logo-color-name.svg" :alt="$t('ellaism')">
        </b-navbar-item>
      </template>
      <template slot="end">
        <LocaleChanger />
      ...
      <template slot="start">
        <b-navbar-dropdown :label="$t('navigation.individual')">
          <b-navbar-item tag="nuxt-link" :to="localePath({ name: 'wallet' })">
            <span>
              <b-icon pack="fas" icon="wallet" />
              {{ $t('navigation.individual_subnav.wallet') }}
            </span>
          </b-navbar-item>
          <b-navbar-item tag="nuxt-link" :to="localePath({ name: 'mining' })">
            <span>
        ...
        <b-navbar-dropdown :label="$t('navigation.developer')">
          <b-navbar-item tag="nuxt-link" :to="localePath({ name: 'testnet' })">
            <span>
              <b-icon pack="fas" icon="server" />
              {{ $t('navigation.developer_subnav.testnet') }}
            </span>
          </b-navbar-item>
          <b-navbar-item tag="nuxt-link" :to="localePath({ name: 'dapp' })">
            <span>
              <b-icon pack="fas" icon="window-restore" />
              {{ $t('navigation.developer_subnav.dapp') }}
            </span>
          </b-navbar-item>
          <b-navbar-item tag="nuxt-link" :to="localePath({ name: 'bot' })">
            <span>
        ...
        <b-navbar-dropdown :label="$t('navigation.resource')">
          <b-navbar-item tag="div">
            <strong>{{ $t('navigation.resource_subnav.official') }}</strong>
          </b-navbar-item>
          ...
          <b-navbar-item href="https://explorer.anyblock.tools/ethereum/ellaism/mainnet/" rel="nofollow">
            <span>
              <b-icon pack="fas" icon="cubes" />
          ...
          <b-navbar-item href="https://twitter.com/ellacommunity" rel="nofollow">
            <span>
              ...
              {{ $t('navigation.resource_subnav.twitter') }}
            </span>
          </b-navbar-item>
        </b-navbar-dropdown>
        <b-navbar-item tag="nuxt-link" :to="localePath({ name: 'donate' })">
          {{ $t('navigation.donate') }}
        </b-navbar-item>
        <b-navbar-item tag="nuxt-link" :to="localePath({ name: 'about' })">
          {{ $t('navigation.about') }}
        </b-navbar-item>
      </template>
    </b-navbar>
